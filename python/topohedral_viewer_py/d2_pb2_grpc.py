...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in d2_pb2_grpc.py depends on'
...
class StateServiceServicer(object):
    ...
    def AddAxes(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_StateServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'd2rpc.StateService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('d2rpc.StateService', rpc_method_handlers)
